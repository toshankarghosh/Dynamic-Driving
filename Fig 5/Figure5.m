...
%                          ',\gamma \tau/m =',num2str( gamma_k_ratio,'%1.1f'));
             ...
             legend box off
              ...
              LL=strcat('$\,\gamma=$',num2str(gamma_list(jj),'%1.1f'),...
                 ...
                 text(min(xlim), min(ylim)+1e-4 ,LL,'FontSize',22,'Interpreter','latex' );
...
t2_list_n1=[0.0750 0.065 0.0500  0.03500 0.03 0.02500 ];
...
colororder(parula(length(beta)+1))
 ...
 LL=strcat('$\,\gamma=$',num2str(gamma_list(1),'%1.1f'),...
                 ...
                 text(min(xlim), min(ylim)+.5e-2 ,LL,'FontSize',22,'Interpreter','latex' );
